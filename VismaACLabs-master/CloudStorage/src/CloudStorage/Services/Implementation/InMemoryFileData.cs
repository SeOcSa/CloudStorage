...
namespace CloudStorage.Services.Implementation
{
    public class InMemoryFileData : IFileData
    {
        ...
        public IEnumerable<FileInfo> FilterBy(string term,string companyId=null, string owner=null)
        {
            throw new NotImplementedException();
        }

        public IEnumerable<FileInfo> FilterBy(string term, string companyId = null)
        {
            throw new NotImplementedException();
        }
